...
| `spec-interview-gapfill` | question | — | `skills/refine/references/specify.md` — 2. Interview | Structured spec interview: probe the user, batching only independent questions. |
