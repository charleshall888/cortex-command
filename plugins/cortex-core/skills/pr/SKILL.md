...
6. Create the PR in two Bash calls — no `$()` in either call (command substitution creates temp files that fail in sandboxed environments; see `skills/commit/SKILL.md`):
