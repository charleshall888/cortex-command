...
- **The audited corpus** is ~127K tokens of skill prose; the lifecycle cluster alone is ~35K. The interactive lifecycle accumulates a worst-case ~51K tokens of resident phase-reference prose in a single unbroken session [skills/lifecycle/SKILL.md:144].
