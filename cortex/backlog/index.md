...
| 230 | Release-gate empirical from-Claude-session smoke test for #228 daytime dispatch | backlog | high | chore | — | — | — |
...
| 231 | Fix _get_next_id in cortex-create-backlog-item to ignore IDs >=990 (seed fixture range) | refined | low | chore | — | — | ✓ |
...
- **231** Fix _get_next_id in cortex-create-backlog-item to ignore IDs >=990 (seed fixture range)

## Backlog

- **230** Release-gate empirical from-Claude-session smoke test for #228 daytime dispatch
