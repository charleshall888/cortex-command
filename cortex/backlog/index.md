...
|-----|-------|--------|----------|------|------------|--------|------|
| 228 | Wire daytime dispatch through cortex CLI + MCP with launchd detachment | superseded | high | feature | — | — | ✓ |
...
| 249 | Lifecycle implement: auto-enter worktree, drop the cd handoff | refined | medium | feature | — | — | ✓ |
