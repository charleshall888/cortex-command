...
| 279 | cortex-check-contract false-positives on hook-script mentions and subcommand flags | backlog | medium | bug | — | — | — |
...
- **279** cortex-check-contract false-positives on hook-script mentions and subcommand flags
