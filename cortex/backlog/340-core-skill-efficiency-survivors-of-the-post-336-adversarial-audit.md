...
- ~~The event-migration of the clarify-critic and plan-comparison sites — contested by a dual-producer parity argument; default-dropped pending that question.~~ **The plan-comparison half is settled (2026-07-20): #398 deleted the event** — the §g emitter, registry row, and ADR-0020 exemption are gone. The clarify-critic half is untouched and stays parked.
