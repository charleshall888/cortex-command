...
blocks: []
blocked-by: []
discovery_source: cortex/research/post-113-repo-state/research.md
complexity: complex
criticality: high
spec: cortex/lifecycle/archive/apply-post-113-audit-follow-ups-stale-doc-cleanup-lifecycle-archive-run-mcp-hardening/spec.md
---
