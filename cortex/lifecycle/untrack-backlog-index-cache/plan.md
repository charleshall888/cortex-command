...
- **Status**: [x] done (verification-only; suite 1793 passed, lone failure is a sandbox pypi.org network block that passes with network; runtime missing-index PASS; zero plugin drift)
