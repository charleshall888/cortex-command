...
- **Context**:
  ...
  - **Reference artifact**: `lifecycle/archive/restructure-critical-review-step-4-to-suppress-dismiss-output/spec.md` contains the full R1–R10 requirement text and acceptance-criteria convention.
