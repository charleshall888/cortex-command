...
The authoritative per-candidate rationale lives in `lifecycle/archive/audit-skill-prompts-and-remove-verbose-instructions-above-the-floor/research.md`. This DR-6 note is a pointer, not a duplicate — do not re-litigate the rubric here; trace the specific counter-argument to its research.md section.
