...
- `lifecycle/archive/apply-confirmed-safe-permission-tightening/spec.md` (056 spec — pattern style reference)
- `lifecycle/archive/close-exfiltration-channels-in-sandbox-excluded-commands/spec.md` (058 spec — subcommand-scoping style reference with flag-position variants)
