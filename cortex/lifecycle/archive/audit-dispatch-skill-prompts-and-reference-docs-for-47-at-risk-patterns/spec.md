...
- **ADDED**: `lifecycle/archive/audit-dispatch-skill-prompts-and-reference-docs-for-47-at-risk-patterns/candidates.md` — per-site exclusion decisions and per-pattern remediation tables.
