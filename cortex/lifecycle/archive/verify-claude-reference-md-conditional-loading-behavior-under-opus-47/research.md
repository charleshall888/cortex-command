...
- **Lifecycle working artifact**: this file (`lifecycle/archive/verify-claude-reference-md-conditional-loading-behavior-under-opus-47/research.md`), plus eventual `spec.md` and `events.log` appends.
