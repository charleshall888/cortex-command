"""Stub for cortex-morning-review-gc-demo-worktrees (promoted in a later task).
...
def main(argv: Optional[List[str]] = None) -> int:
    ...
    sys.stderr.write(
        "cortex-morning-review-gc-demo-worktrees: stub entry point; real "
        "port lands in a later task of "
        "installation-integrity-layer-bash-to-entry.\n"
    )
    sys.exit(70)
