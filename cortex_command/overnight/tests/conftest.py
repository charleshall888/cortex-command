...
Stubs out cortex_command.backlog.update_item before any test in this
package imports from cortex_command.overnight.batch_runner.  The stub must
be in sys.modules before batch_runner.py is first imported because
...
# ---------------------------------------------------------------------------
# Stub cortex_command.backlog.update_item.
