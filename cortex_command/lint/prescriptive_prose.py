"""Stub for cortex-check-prescriptive-prose (promoted in a later task).
...
def main(argv: Optional[List[str]] = None) -> int:
    ...
    sys.stderr.write(
        "cortex-check-prescriptive-prose: stub entry point; real port lands "
        "in a later task of installation-integrity-layer-bash-to-entry.\n"
    )
    sys.exit(70)
