...
const NOTES = {
  ...
  "sc-prism": {
    beats: [
      ...
      "(the sea folds; the rail forks) “So I spend that first 20% deliberately. It always starts the same — the interview. Then I take one of two roads. Top: I break it into tickets. Bottom: I hand it the goal and let it run. Top first.”",
      "(the bottom road steps aside; head + cloud) “The epic — still just a cloud in my head.”",
      ...
      "(the tickets fold away; the bottom road lights) “Now the other road. Same interview, same doc — but I also hand over how to check it's done. That list is what lets me walk away.”",
      ...
      "(the red loop, the red chunks) “Here's the catch. It lands near what I wanted, not on it. I expect to redirect it and rework at the end — and that's more tokens. So: tickets keep me close and cost less. The long run costs more and needs fixing at the end — but I'm only deep in the planning. I pick it for big jobs when I have the tokens.”",
    ],
    exit: "“Either way, it starts from the doc. And a fresh window has one more use: point it at your own work.”",
  },
  "sc-arrows": {
    beats: [
