...
**`cortex/lifecycle.config.md` schema** — `cortex init` scaffolds this file with YAML frontmatter for project-specific overrides. Six keys total, three active (consumed by code) and three advisory (scaffolded but not yet wired up):
