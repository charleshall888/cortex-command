...
# Run skill-design test infrastructure (L1 surface, prose absences, size budget, lifecycle refs)
test-skill-design:
    .venv/bin/pytest tests/test_l1_surface_ratchet.py tests/test_skill_prose_absences.py tests/test_skill_size_budget.py tests/test_reference_size_ratchet.py tests/test_lifecycle_references_resolve.py -q
