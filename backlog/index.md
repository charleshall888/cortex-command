...
| 115 | Rebuild overnight runner under cortex CLI | backlog | high | feature | — | 113 | — |
| 116 | Build MCP control-plane server with versioned runner IPC contract | backlog | high | feature | 115 | 113 | — |
| 118 | Ship curl | sh bootstrap installer for cortex-command | backlog | high | feature | — | 113 | — |
| 120 | Publish cortex-interactive plugin (non-runner skills + hooks + bin utilities) | backlog | high | feature | — | 113 | — |
...
- **115** Rebuild overnight runner under cortex CLI
