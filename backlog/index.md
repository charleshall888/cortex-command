...
| 124 | Migration guide + script for existing symlink-based installs | backlog | medium | chore | 118 | 113 | — |
...
- **124** Migration guide + script for existing symlink-based installs
