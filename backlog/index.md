...
| 10 | Fix skill sub-file path bug across all skills | in_progress | high | chore | — | 009 | — |
...
| 15 | Surface conflict details inline in morning report | backlog | high | chore | — | 014 | — |
| 16 | Add recovery guidance to morning report for conflicted features | backlog | high | chore | — | 014 | — |
...
- **15** Surface conflict details inline in morning report
...
- **10** Fix skill sub-file path bug across all skills (in_progress)
