...
|-----|-------|--------|----------|------|------------|--------|------|
| 66 | Suppress non-decision output in interactive lifecycle phases | backlog | high | epic | — | — | — |
...
| 77 | Rename batch_runner to orchestrator and add integration tests | in_progress | high | feature | — | 074 | — |
...
| 79 | Integrate autonomous worktree option into lifecycle pre-flight | backlog | medium | feature | — | 074 | — |
...
- **66** Suppress non-decision output in interactive lifecycle phases
...
- **79** Integrate autonomous worktree option into lifecycle pre-flight

## In-Progress

- **77** Rename batch_runner to orchestrator and add integration tests (in_progress)
