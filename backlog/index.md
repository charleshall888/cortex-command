...
| 182 | Vertical-planning adoption: ## Outline in plan.md + ## Phases in spec.md + P9/S7 gates + parser regression test | backlog | high | feature | 174, 175, 176 | 172 | — |
...
| 171 | Remove /fresh, /evolve, and /retro skills | backlog | medium | chore | — | — | — |
...
| 179 | Extract conditional content blocks to references/ (state-init split, plan-competing, research-parallel, implement-daytime, a-b-downgrade-rubric, parallel-execution) | backlog | medium | chore | 174, 175, 176, 177 | 172 | — |
...
| 183 | Migrate complexity-escalation gates to deterministic Python hook (cortex-complexity-escalator) | backlog | medium | feature | 174, 177 | 172 | — |
...
- **171** Remove /fresh, /evolve, and /retro skills
