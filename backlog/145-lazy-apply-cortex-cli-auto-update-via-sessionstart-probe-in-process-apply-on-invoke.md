...
- **Ticket 125 (Homebrew tap) closed as `wontfix`** — the wrapper-Formula approach was found architecturally unsupported (Pattern B 0/N in survey) and the brew tap's discoverability value did not justify the mismatch; see `lifecycle/archive/homebrew-tap-as-thin-wrapper-around-the-curl-installer/` for the full research and closure rationale. Auto-update (this ticket) was surfaced during 125's design review as a genuinely separate UX improvement and was confirmed feasible via measured timings.
