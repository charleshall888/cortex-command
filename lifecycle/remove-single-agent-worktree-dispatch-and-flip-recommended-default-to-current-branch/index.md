...
# [[097-remove-single-agent-worktree-dispatch-and-flip-recommended-default|Remove single-agent worktree dispatch and flip recommended default to current branch]]

Feature lifecycle for [[097-remove-single-agent-worktree-dispatch-and-flip-recommended-default]].
