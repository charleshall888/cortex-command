...
- `grep -E '^artifacts:' lifecycle/build-shared-synthesizer-for-critical-tier-dual-plan-flow-interactive-overnight/index.md` → `artifacts: [research, spec, plan]`. Spec and plan both registered.
