...
- **Files**: `lifecycle/add-subagent-output-formats-compress-synthesis/axis-b-baseline.md` (created by this task)
...
- **Context**:
  ...
  - Write all counts to `lifecycle/add-subagent-output-formats-compress-synthesis/axis-b-baseline.md` in this format:
    ```
    ## Baseline Counts
...
- **Verification**:
  - `ls lifecycle/add-subagent-output-formats-compress-synthesis/axis-b-baseline.md` — file exists
...
- **Files**: `lifecycle/add-subagent-output-formats-compress-synthesis/axis-b-candidates.md` (created by this task)
...
- **Context**:
  ...
  - Write the confirmed-candidate list to `lifecycle/add-subagent-output-formats-compress-synthesis/axis-b-candidates.md` with per-file, per-pattern documentation of each match and exclusion-category decision. Task 8 reads this file.
  - Expected output: most files show zero qualifying candidates; document every match even if excluded
- **Verification**:
  - `ls lifecycle/add-subagent-output-formats-compress-synthesis/axis-b-candidates.md` — file exists
...
- **What**: Read the confirmed-candidate list from `lifecycle/add-subagent-output-formats-compress-synthesis/axis-b-candidates.md`. Apply B1 core-table rewrites and B2 analogue confirmation passes to the confirmed candidate files only. Use pattern-bucketed commits (one commit per pattern that has ≥ 1 real instance). For patterns with zero qualifying instances, log as "confirmed zero" and skip the commit. Record post-edit grep counts per file.
- **Depends on**: [7]
- **Complexity**: simple
- **Context**:
  - Read `lifecycle/add-subagent-output-formats-compress-synthesis/axis-b-candidates.md` to determine which files and lines need edits
  - Read `lifecycle/add-subagent-output-formats-compress-synthesis/axis-b-baseline.md` (from Task 1) to retrieve pre-edit per-file counts for post-edit comparison
...
- **Context**:
  ...
  - B1/B2: read pre-edit baseline from `lifecycle/add-subagent-output-formats-compress-synthesis/axis-b-baseline.md`; compare post-edit per-file grep counts — post-edit count must be ≤ pre-edit count per file
