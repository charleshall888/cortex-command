...
> Epic reference: `research/audit-and-improve-discovery-skill-rigor/research.md` DR-1(c) Work Item #1 (Approach A). #139 is the C-half and consumes this ticket's marker format. See `lifecycle/codify-citation-norm-and-premise-as-verification-in-discovery-research-phase/research.md` for investigation and cross-agent findings.
