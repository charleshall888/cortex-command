...
- **Files**: `lifecycle/apply-per-spawn-sandboxfilesystemdenywrite-at-all-overnight-spawn-sites/preflight.md`
...
- **Verification**: `grep -E '^PASS:' lifecycle/apply-per-spawn-sandboxfilesystemdenywrite-at-all-overnight-spawn-sites/preflight.md` returns at least one match — pass if grep exit 0.
- **Status**: [ ] pending
