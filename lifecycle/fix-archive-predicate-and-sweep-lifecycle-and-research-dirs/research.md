...
- `backlog/029-add-playwright-mcp-for-dashboard-visual-evaluation.md:59` — cites `lifecycle/archive/add-playwright-htmx-test-patterns-to-dev-toolchain/research.md` as research source.
