...
- **Files**: `cortex_command/cli.py`, `cortex_command/install_guard.py`, `lifecycle/archive/non-editable-wheel-install-support-for-cortex-command/spec.md` (R2d amendment).
