...
- **Complexity**: complex
- **Context**:
  - Source for verbatim strings: `lifecycle/archive/decide-and-document-post-47-policy-settings-must-escalation-tone-regression/spec.md` requirements R1–R11. Quote the spec's verbatim clauses unmodified — the substring grep checks (Task 2) require exact matches.
