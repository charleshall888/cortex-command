...
- **Files**: `lifecycle/archive/define-evaluator-rubric-for-software-features-spike/research.md`
...
- **Verification**: `grep -c '## Question' lifecycle/archive/define-evaluator-rubric-for-software-features-spike/research.md` = 3 — pass if count is 3
- **Status**: [x] complete
...
- **Verification**: `grep -c '## Skepticism Tuning Protocol' lifecycle/archive/define-evaluator-rubric-for-software-features-spike/research.md` = 1 — pass if count is 1
- **Status**: [x] complete
...
- **Files**: `lifecycle/archive/define-evaluator-rubric-for-software-features-spike/index.md`
...
- **Verification**: `grep -c 'plan' lifecycle/archive/define-evaluator-rubric-for-software-features-spike/index.md` >= 2 — pass if count is at least 2 (artifacts array + wikilink)
- **Status**: [x] complete

## Verification Strategy

Run all spec acceptance criteria in sequence:
1. `grep -c '## Question' lifecycle/archive/define-evaluator-rubric-for-software-features-spike/research.md` = 3
...
4. `grep -c '## Skepticism Tuning Protocol' lifecycle/archive/define-evaluator-rubric-for-software-features-spike/research.md` = 1
5. `grep -c 'Alternative F' lifecycle/archive/define-evaluator-rubric-for-software-features-spike/research.md` >= 2
