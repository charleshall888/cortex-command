...
- **Files**: (committed on `main` before branching, NOT on the feature branch)
  - `lifecycle/archive/delete-post-shift-orphan-code-scripts-hooks-and-retire-paired-requirements/research.md`
  - `lifecycle/archive/delete-post-shift-orphan-code-scripts-hooks-and-retire-paired-requirements/spec.md`
  - `lifecycle/archive/delete-post-shift-orphan-code-scripts-hooks-and-retire-paired-requirements/plan.md`
  - `lifecycle/archive/delete-post-shift-orphan-code-scripts-hooks-and-retire-paired-requirements/events.log`
  - `lifecycle/archive/delete-post-shift-orphan-code-scripts-hooks-and-retire-paired-requirements/index.md`
  - `lifecycle/archive/delete-post-shift-orphan-code-scripts-hooks-and-retire-paired-requirements/critical-review-residue.json`
...
- **Verification**:
  ...
  test -e lifecycle/archive/delete-post-shift-orphan-code-scripts-hooks-and-retire-paired-requirements/plan.md && \
  test -e lifecycle/archive/delete-post-shift-orphan-code-scripts-hooks-and-retire-paired-requirements/critical-review-residue.json && \
