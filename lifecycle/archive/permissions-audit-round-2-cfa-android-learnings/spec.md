...
> **Background**: epic research and 054-058 decisions referenced but not reproduced. See `research/permissions-audit/research.md` (epic research with DR-1..DR-8), `lifecycle/archive/apply-confirmed-safe-permission-tightening/spec.md` (056 — canonical "bundled removal" style), and `lifecycle/archive/close-exfiltration-channels-in-sandbox-excluded-commands/spec.md` (058 — canonical "subcommand scoping + flag-position variants" style).
...
- **Spec style reference**: match 056 spec (`lifecycle/archive/apply-confirmed-safe-permission-tightening/spec.md`) structure — R-numbered requirements with jq-based acceptance criteria.
