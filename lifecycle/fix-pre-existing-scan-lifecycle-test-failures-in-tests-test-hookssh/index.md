...
# [[170-fix-pre-existing-scan-lifecycle-test-failures-in-tests-test-hookssh|Fix pre-existing scan-lifecycle test failures in tests/test_hooks.sh]]

Feature lifecycle for [[170-fix-pre-existing-scan-lifecycle-test-failures-in-tests-test-hookssh]].
