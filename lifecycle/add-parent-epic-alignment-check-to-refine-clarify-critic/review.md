...
- **Actual**: Spec line 76 documents all four: 70% threshold, 10 consecutive runs, legacy-event exclusion, invariant-violation reported separately. `grep -c "70%" lifecycle/add-parent-epic-alignment-check-to-refine-clarify-critic/spec.md` returns 2.
- **Verdict**: PASS
