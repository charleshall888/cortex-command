...
- **Files**:
  - `lifecycle/extract-overnight-orchestrator-round-state-read-into-bin-orchestrator-context/verification.md` (new)
...
- **Verification**:
  - `grep -cE '^baseline_tokens:' lifecycle/extract-overnight-orchestrator-round-state-read-into-bin-orchestrator-context/verification.md` ≥ 1 — pass if count ≥ 1.
...
3. **Acceptance grep matrix** (one command, all R-criteria):
   ...
   grep -cE '^baseline_tokens:' lifecycle/extract-overnight-orchestrator-round-state-read-into-bin-orchestrator-context/verification.md  # >= 1 (R11)
   ```
