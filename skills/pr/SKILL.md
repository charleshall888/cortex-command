---
name: pr
description: Create GitHub pull requests with well-crafted titles and descriptions. Use when user says "pr", "/pr", "create a pr", "open a pull request", "submit a pr", "make a pull request", or asks to get their changes ready for review.
inputs: []
outputs:
...
4. If there are uncommitted changes, warn the user and stop — they should `/commit` first
