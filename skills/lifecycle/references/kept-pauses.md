...
- `skills/lifecycle/references/backlog-writeback.md:7` — backlog write-back complete-lifecycle prompt on a backlog item already marked complete.
- `skills/lifecycle/references/complete-first-run.md:36` — phase-exit pause: merge-wait pause inside the multi-step Complete phase; user re-invokes /cortex-core:lifecycle complete <slug> after merging on GitHub.
